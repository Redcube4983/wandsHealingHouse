...
<div id="about-us">
	<div class="top-visual-area">
		<div class="img">
			<picture class="">
				<source media="(max-width: 767px)" srcset="<?php echo get_template_directory_uri(); ?>/images/about-us/main_visual-sp.jpg 1x,<?php echo get_template_directory_uri(); ?>/images/about-us/main_visual-sp.jpg 2x">
				<source media="(max-width: 920px)" srcset="<?php echo get_template_directory_uri(); ?>/images/about-us/main_visual-pc.jpg 1x,<?php echo get_template_directory_uri(); ?>/images/about-us/main_visual-pc.jpg 2x">
				<img src="<?php echo get_template_directory_uri(); ?>/images/about-us/main_visual-pc.jpg" alt="トップ背景画像">
			</picture>
		</div>
	</div>
	<div class="breadcrumbs-area">
		<ul class="breadcrumbs-list">
			...
			<li>ワンズヒーリングハウスについて</li>
		</ul>
	</div>
	<div class="lead-area">
		<div class="ttl-wrap">
			<h4 class="en">About Us</h4>
			<h3 class="jp">ワンズヒーリングハウスについて</h3>
		</div>
	...
	<div class="contents-area">
        <div class="top-description-area">
            ...
            <ul class="img-wrap">
                ...
                <li><img src="<?php echo get_template_directory_uri(); ?>/images/about-us/aboutUs_img02.jpg" alt=""></li>
                <li><img src="<?php echo get_template_directory_uri(); ?>/images/about-us/aboutUs_img03.jpg" alt=""></li>
                <li><img src="<?php echo get_template_directory_uri(); ?>/images/about-us/aboutUs_img04.jpg" alt=""></li>
            </ul>
        </div>
        <ul class="sub-description-area">
            <li>
            ...
            <li>
                ...
                <div class="text-wrap">
                    <p class="profile"><span>藤原　シュウ</span><br>エグゼクティブ プロデューサー</p>
                    <div class="box">
                        <p>北海道・阿寒生まれ。東京でナイトレジャーの空間開発、食品プロデュースを行い、行列を作る店舗や商品を数々創造し、ヒットメーカーと呼ばれる。48歳の時、クンダリーニ覚醒者と出会い、家族で京都に移住。スピリチュアル自己探究により、人生が大きく転換した。58歳でミハエルノブコと20年ぶりに再会し、パートナーシップを組む（ツインレイ）。移住して16年経った2024年、東京へ戻り、第二の人生が本格的に始まった。</p>
